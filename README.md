...
Clone this repository to your desired folder:
  ...
  cd my-folder
  git clone https://github.com/Esmatullah12/vet-clinic-database.git
...
Feel free to check the [issues page](https://github.com/Esmatullah12/vet-clinic-database/issues).
